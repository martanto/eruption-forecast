...
def get_windows_information(trace: Trace, window_duration_minutes: int = 10,) -> dict[str, int | float]:
...
def calculate_window_metrics(
    ...
    remove_outliers_bool: bool = True,
    ...
    Args:
        ...
        remove_outliers_bool (bool, optional): Whether to remove outliers before calculation. Defaults to True.
    ...
    for index_window in range(total_windows):
        ...
        if length_window_data > 0:
             if remove_outliers_bool and (length_window_data > minimum_samples):
        ...
        window_time = start_datetime + timedelta(minutes=index_window * window_duration_minutes)
